...
INSERT INTO verifications (user_id, verification_type, email, otp_hash) VALUES ($1, $2, $3, $4) RETURNING id, user_id, verification_type, email, otp_hash, created_at, expires_at
`
...
func (q *Queries) StoreOrUpdateVerification(ctx context.Context, arg StoreOrUpdateVerificationParams) (Verification, error) {
